...
//    m_GadgetDir = ((CDiskInfoApp*)AfxGetApp())->m_GadgetDir;
    ...
    m_SettingDlg = NULL;
    m_HealthDlg = NULL;
    m_TemperatureDlg = NULL;
    m_OptionDlg = NULL;
    m_SoundSettingDlg = NULL;
...
CDiskInfoDlg::~CDiskInfoDlg()
{
    ...
    if (m_AboutDlg) delete m_AboutDlg;
    if (m_SettingDlg) delete m_SettingDlg;
    if (m_HealthDlg) delete m_HealthDlg;
    if (m_TemperatureDlg) delete m_TemperatureDlg;
    if (m_OptionDlg) delete m_OptionDlg;
    if (m_SoundSettingDlg) delete m_SoundSettingDlg;
